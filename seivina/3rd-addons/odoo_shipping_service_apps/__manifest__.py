...
#################################################################################
{
    ...
    "summary":  """ODOO-Shipping Service API Integration: PROVIDE CORE SERVICE LAYER FOR API INTEGRATION With 
                    ...
                    FreightView | DPD | Easyship | Easypost | Easyship | Easypost | GLS | FedEx | UPS | DHL | Aramex |  Shipstation | PLT | ETD | Swiss | Postnord | Royalmail | fedex etd | chronopost | yodel | purolator | japanpost | chinaems | singpost | correos | Shipping Delivery 
            """,
    "category":  "Warehouse",
    "version":  "1.0.1",
