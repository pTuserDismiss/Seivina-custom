...
<odoo>
  <!-- Copyright (c) 2018-Present Webkul Software Pvt. Ltd. (<https://webkul.com/>) -->
    ...
    <record id="delivery_carrier_package_list" model="ir.ui.view">
        <field name="name">product.package.form</field>
        <field name="model">product.package</field>
        <field name="type">list</field>
        <field name="arch" type="xml">
            <list string='Product Package' >
            ...
            <xpath expr="//notebook/page[last()]" position="after">
                <page string='Product Package' name='package'>
                    ...
                    <group invisible="create_package == 'auto'">
                         ...
                         <field name='wk_packaging_ids' invisible="create_package == 'auto'"
                          context="{
                          'tree_view_ref': 'odoo_shipping_service_apps.delivery_carrier_package_list',
