...
class TaxjarTaxRate(models.Model):
    ...
    ts_exemption_type = fields.Selection(_get_ts_exemption_type, default='non_exempt', string='TaxJar Exempt Type',help='This values used while calculating order taxes and invoice upload to TaxJar for this partner.')
