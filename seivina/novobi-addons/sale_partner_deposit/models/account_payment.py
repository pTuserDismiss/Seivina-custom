...
class AccountPayment(models.Model):
    ...
    sale_deposit_id = fields.Many2one(
    ...
    def _onchange_sale_deposit_partner_id(self):
        ...
        if self.sale_deposit_id.partner_id.commercial_partner_id != commercial_partner:
    ...
    def action_post(self):
        ...
        for record in self.filtered(lambda r: r.sale_deposit_id and r.state == 'draft'):
